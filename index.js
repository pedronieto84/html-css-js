...
function operacionMatematica( numero1, numero2, numero3) {
    switch (numero3) {
        case "suma":
...
const ciudades =["Barcelona", "Madrid", "Valencia" , "Valladolid", "Seviila", indice]
...
const miObjeto = {email:"barcelona@gmail" , password:"123456" , nombre:"Juan"};
